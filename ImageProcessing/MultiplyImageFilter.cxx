...
int main(int, char *[])
{
  ...
  ConnectorType::Pointer multiplyConnector = ConnectorType::New();
  multiplyConnector->SetInput(multiplyFilter->GetOutput());

  vtkSmartPointer<vtkImageActor> multiplyActor =
    vtkSmartPointer<vtkImageActor>::New();
  multiplyActor->SetInput(multiplyConnector->GetOutput());
  ...
  rightRenderer->AddActor(multiplyActor);
