...
int main(int, char *[])
{
  ...
  typedef itk::LabelMapOverlayImageFilter<ImageType, BinaryImageToLabelMapFilterType::OutputImageType, RGBImageType>
  ...
  labelMapOverlayImageFilter->SetInput(image);
  labelMapOverlayImageFilter->SetFeatureImage(binaryImageToLabelMapFilter->GetOutput());
