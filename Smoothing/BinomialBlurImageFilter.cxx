...
*/
  ...
  typedef itk::ImageToVTKImageFilter<UnsignedCharImageType> ConnectorType;
  ConnectorType::Pointer blurredConnector = ConnectorType::New();
  blurredConnector->SetInput(blurFilter->GetOutput());

  vtkSmartPointer<vtkImageActor> blurredActor =
    vtkSmartPointer<vtkImageActor>::New();
  blurredActor->SetInput(blurredConnector->GetOutput());
  ...
  rightRenderer->AddActor(blurredActor);
